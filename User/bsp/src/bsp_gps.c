...
*********************************************************************************************************
*	函 数 名: gpsGNGGA
*	功能说明: 分析0183数据包中的 GNGGA 命令，结果存放到全局变量
*	形    参:  _ucaBuf  收到的数据
*			 _usLen    数据长度
*	返 回 值: 无
*********************************************************************************************************
*/
/*
例：$GNGGA,092204.999,4250.5589,S,14718.5084,E,1,04,24.4,19.7,M,,,,0000*1F
...
字段13：校验值
*/
void gpsGNGGA(uint8_t *_ucaBuf, uint16_t _usLen)
{
	char *p;
...
//蔡甸区
$GNGGA,161037.000,3030.6548,N,11402.4568,E,1,04,5.2,51.1,M,-15.5,M,,0000*42
...
//第2次
$GNGGA,165538.000,3030.6519,N,11402.4480,E,2,05,1.9,39.5,M,-15.5,M,6.8,0000*68
...
$GNGGA,165539.000,3030.6519,N,11402.4480,E,2,05,1.9,39.5,M,-15.5,M,7.8,0000*68
$GPRMC,
